...
export default function IndustriesWeCater() {
  return (
    <section className="relative py-8 2xl:py-16 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
      <div className="max-w-[1550px] mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        {/* Header */}
      ...
      <div className="max-w-[1550px] mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 lg:gap-4">
          {industries.map((industry, index) => (
            ...
            >
              ...
              >
                <div className="relative w-full h-36 lg:h-40 2xl:h-55 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 shadow-sm">
                  {/* Background Image */}
                  <Image
                    src={industry.image}
                    alt={industry.name}
                  ...
                  <div className="relative h-full flex flex-col justify-end p-3">
                    ...
                    {/* Name */}
                    <div>
                      <h3 className="text-xs lg:text-sm font-bold text-white line-clamp-2">
                        {industry.name}
                      </h3>
                    </div>
                  </div>
