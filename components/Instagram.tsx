...
const InstagramReels = () => {
  return (
    <section className="relative py-6 md:py-6 lg:py-8 xl:py-8 bg-gradient-to-b from-gray-50 to-white overflow-visible">
      ...
      <div className="relative z-20 max-w-[1500px] mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-8 ">
      ...
      <div className="relative z-10 max-w-[1500px] mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-8">
        <div
        ...
        {/* Watermark Hide */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-72 h-15 bg-white z-50"></div>
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-72 h-12 bg-white z-50"></div>
      </div>
    </section>
  );
};
