      ...
      <div className="max-w-[1450px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center">
          <Link
            ...
            className="group flex items-center gap-3 bg-white border-2 border-[#0093cb] text-[#0093cb] px-4 py-2 rounded-full font-semibold text-sm hover:bg-[#0093cb] hover:text-white transition-all duration-300 transform hover:scale-105"
          >
            <span>View All</span>
...
function TrendingProducts() {
  ...
  return (
    <section className="w-full bg-[#f8fafc] py-16 md:py-20 xl:py-16 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="max-w-[1450px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center items-center gap-3">
            <div className="w-8 h-[2px] bg-[#0093cb]/30" />
            <div className="w-16 h-1 bg-[#0093cb] rounded-full" />
            <div className="w-8 h-[2px] bg-[#0093cb]/30" />
          </div>
        </div>
        ...
        <div className="relative">
          ...
          >
            {/* Gradient Fade Edges */}
            <div className="absolute left-0 top-0 bottom-0 w-24 lg:w-32 bg-gradient-to-r from-[#f8fafc] to-transparent z-10 pointer-events-none" />
            ...
            >
              {duplicatedProducts.map((item, index) => (
                <Link
                  ...
                  className="group relative h-[280px] sm:h-[300px] lg:h-[320px] 
