        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-14 mb-10">
          ...
          <div>
            <img
              ...
              className="scale-110 h-18 md:h-25"
            />
            ...
            <div className="space-y-2 text-sm">
              <a
                ...
                className="flex items-center gap-2 hover:text-[var(--clr-primary)]"
              >
            ...
            <div className="flex gap-3 mt-4">
              ...
              {/* Instagram - Gradient Style without border */}
          ...
          <div>
            <h3
              className="text-white text-lg font-medium mb-4 pb-2 
              ...
              {categories.map((item) => (
                <li key={item.slug}>
                  ...
                  >
                    <ChevronRight
                      size={12}
                      className="text-[var(--clr-primary)] group-hover:translate-x-1 transition-transform"
                    />
                    <span>{item.name}</span>
                  </Link>
                </li>
