...
const featuredTestimonials = [
  {
    id: 1,
    quote: "The personalized executive hampers for our board members were exquisite. Param Corporation's attention to detail is unmatched.",
    name: "Rajesh Menon",
    role: "VP of Human Resources",
    company: "TATA CONSULTANCY SERVICES",
    stat: "500+ GIFTS DELIVERED",
    initials: "RM",
    avatarColor: "green",
    productImage: "https://images.unsplash.com/photo-1549465220-1a8b9238cd48?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: 2,
    quote: "Our Diwali distribution across 12 locations was seamless. The eco-friendly packaging received immense praise from our team.",
    ...
    initials: "SM",
    avatarColor: "teal",
    productImage: "https://images.unsplash.com/photo-1513201099705-a9746e1e201f?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: 3,
    quote: "Finding a partner who understands premium branding while maintaining scale was tough until we found this team.",
    name: "Ananya Iyer",
    ...
    initials: "AI",
    avatarColor: "blue",
    productImage: "https://images.unsplash.com/photo-1523293182086-7651a899d37f?q=80&w=800&auto=format&fit=crop",
  }
];

const sideTestimonials = [
  {
    quote: "We've been working with Param for 5 years now. They handle gifts for our 3,000+ employees flawlessly.",
    name: "Sneha Kapoor",
    role: "Head of Procurement",
    company: "INFOSYS BPM",
    stat: "5-YEAR PARTNERSHIP",
  ...
  {
    quote: "The quality of their curated hampers helped us strengthen our relationship with key clients. It's a statement.",
    name: "Arjun Patel",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-[11px] font-medium tracking-[0.18em] uppercase text-[#3B6D11]">
              Client Testimonials
            </p>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-[#1a1a1a] leading-tight">
            Trusted by <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3B6D11] to-[#0F6E56]">India's largest</span> enterprises
          </h2>
        </motion.div>
              ...
              >
                ...
                <div className="md:w-1/2 p-8 md:p-10 border-r border-[#63992212] flex flex-col justify-between">
                  <div className="relative aspect-[4/5] rounded-xl overflow-hidden shadow-2xl">
                    ...
                    <div className="absolute bottom-4 left-4">
                        <p className="text-white text-[10px] tracking-widest uppercase font-bold">Featured Catalog</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 mt-8">
                    ...
                    <div>
                      <p className="text-[15px] font-bold text-[#1a1a1a]">{featured.name}</p>
                ...
                <div className="md:w-1/2 p-8 md:p-10 flex flex-col bg-[#fcfdfa]">
                  ...
                  <div className="flex-1">
                    <span className="text-[60px] leading-none font-serif text-[#639922] opacity-20 block -mb-4">“</span>
                    ...
                    {featuredTestimonials.map((_, idx) => (
                      <button
                        ...
                        className={`h-1.5 transition-all duration-300 rounded-full ${
                          idx === activeIndex ? "w-10 bg-[#639922]" : "w-2 bg-[#63992233]"
                        }`}
