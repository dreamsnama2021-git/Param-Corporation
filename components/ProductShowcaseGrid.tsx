...
export default function ProductShowcaseGrid() {
  ...
  // Define showcase cards with separate desktop and mobile image support
  const showcaseCards = [
    {
      id: 0,
      badge: "Category 01",
      ...
      desc: "Paperweights, tabletops, promotional merchandise, 3D printed & fibre resin ranges, plants, as per days.",
      mobileDesc: "Paperweights, tabletops, promotional merchandise, 3D printed & fibre resin ranges.",
    ...
    },
    {
      ...
      desc: "Scientific Inputs: As per therapy, write & wipe utility, and flipcharts.",
      mobileDesc: "Scientific write-and-wipe aids, visual therapy panels, and patient consultation toolkits.",
      link: "/medipride",
    ...
    },
    {
      ...
      desc: "Solutions: DigiPRO, QR code based products, and HRA calculators.",
      mobileDesc: "DigiPRO, custom health calculator utilities, and dynamic interactive QR code items.",
      link: "/digital-gifts",
    ...
    },
    {
      ...
      desc: "Products: Creative and unique custom QR code & name based products.",
      mobileDesc: "Creative and unique custom QR code & name based products tailored for HCPs.",
      link: "/personalized",
  ...
  const scrollToCard = (index: number) => {
    ...
    if (carouselRef.current) {
      const cardWidth = carouselRef.current.scrollWidth / showcaseCards.length;
  ...
  const handleScroll = () => {
    if (carouselRef.current) {
      ...
      if (index >= 0 && index < showcaseCards.length) {
        setActiveTab(index);
      }
    }
  };
      ...
      <div className="w-full max-w-[1800px] h-full flex flex-col justify-center">
          ...
          >
            {showcaseCards.map((card) =>
              card.id === 4 ? (
                ...
                >
                  {/* Card Background Mobile Image */}
                  <div
                    className="absolute inset-0 z-0 bg-cover bg-center pointer-events-none scale-105"
                    style={{ backgroundImage: `url("${card.mobileImage || card.desktopImage}")` }}
                  />
        ...
        >
          ...
          <div className="md:col-span-5 flex flex-col gap-4 lg:gap-4 h-full min-h-0">
            ...
            <Link href={showcaseCards[0].link} className="flex-1 flex flex-col min-h-0">
              ...
              >
                ...
                <div
                  ...
                  style={{ backgroundImage: `url("${showcaseCards[0].desktopImage || showcaseCards[0].mobileImage}")` }}
                />
            ...
            <Link href={showcaseCards[1].link} className="flex-1 flex flex-col min-h-0">
              <motion.div
                variants={itemVariants}
                whileHover={{ y: -4 }}
                className="rounded-2xl lg:rounded-3xl p-5 md:p-6 lg:p-5 flex flex-col justify-between flex-1 relative overflow-hidden group shadow-xl cursor-pointer h-full min-h-0"
              >
                ...
                <div
                  className="absolute inset-0 z-0 bg-cover bg-center transition-all duration-700 group-hover:scale-105 pointer-events-none"
                  style={{ backgroundImage: `url("${showcaseCards[1].desktopImage || showcaseCards[1].mobileImage}")` }}
                />
                {/* Top/Bottom Gradient Scrim */}
          ...
          <div className="md:col-span-3 flex flex-col gap-4 lg:gap-4 h-full min-h-0">
            ...
            <Link href={showcaseCards[2].link} className="flex-1 flex flex-col min-h-0">
              ...
              >
                ...
                <div
                  className="absolute inset-0 z-0 bg-cover bg-center transition-all duration-700 group-hover:scale-105 pointer-events-none"
                  style={{ backgroundImage: `url("${showcaseCards[2].desktopImage || showcaseCards[2].mobileImage}")` }}
                />
            ...
            <Link href={showcaseCards[3].link} className="flex-1 flex flex-col min-h-0">
              <motion.div
                variants={itemVariants}
                whileHover={{ y: -4 }}
                className="rounded-2xl lg:rounded-3xl p-5 md:p-6 lg:p-5 flex flex-col justify-between flex-1 relative overflow-hidden group shadow-xl cursor-pointer h-full min-h-0"
              >
                ...
                <div
                  className="absolute inset-0 z-0 bg-cover bg-center transition-all duration-700 group-hover:scale-105 pointer-events-none"
                  style={{ backgroundImage: `url("${showcaseCards[3].desktopImage || showcaseCards[3].mobileImage}")` }}
                />
                {/* Gradient Overlay Scrim */}
          ...
          <div className="md:col-span-4 flex flex-col gap-4 lg:gap-4 h-full min-h-0">
            ...
            <Link href={showcaseCards[5].link} className="flex flex-col min-h-0" style={{ flex: "60 1 0%" }}>
              ...
              >
                ...
                <div
                  className="absolute inset-0 z-0 bg-cover bg-center transition-all duration-700 group-hover:scale-105 pointer-events-none"
                  style={{ backgroundImage: `url("${showcaseCards[5].desktopImage || showcaseCards[5].mobileImage}")` }}
                />
                {/* Gradient Overlay Scrim */}
