...
const AboutUsPage: React.FC = () => {
  return (
    <main className="bg-[#fafcff] text-gray-800 font-sans overflow-hidden">
      ...
      <style>{`
        ...
        .animate-float-delayed { animation: floatReversed 18s ease-in-out infinite; }
            ...
            <div className="relative flex justify-center items-center group perspective-1000">
              ...
              >
                <div className="overflow-hidden rounded-[1.5rem] sm:rounded-[2rem] shadow-xl sm:shadow-2xl shadow-[#0093cb]/20 w-[75%] sm:w-[70%] md:w-[65%] lg:w-[80%] xl:w-[80%] aspect-[4/4.5] relative transition-transform duration-500 ease-out group-hover:-translate-y-1.5 sm:group-hover:-translate-y-2 backdrop-blur-sm bg-white/40">
                  ...
                  />
                  <div className="absolute inset-0 ring-1 ring-inset ring-white/40 rounded-[1.5rem] sm:rounded-[2rem] pointer-events-none" />
                </div>
              </motion.div>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:gap-4 lg:gap-5 xl:gap-6 text-gray-800 xl:pl-6 2xl:pl-10">
              ...
              >
                <span className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 md:px-5 py-1.5 sm:py-2 md:py-2.5 rounded-full bg-[#00a65d]/10 border border-[#00a65d]/20 text-[#00a65d] text-[10px] sm:text-xs font-black uppercase tracking-[0.25em] backdrop-blur-md shadow-sm">
                  <span className="w-1 sm:w-1.5 h-1 sm:h-1.5 rounded-full bg-[#00a65d] animate-pulse" />
                  About Us
                </span>
              </motion.div>
              ...
              <motion.h2
                ...
                className="text-2xl sm:text-3xl md:text-4xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-extrabold tracking-tight leading-[1.1] text-gray-900 pb-1 sm:pb-2"
              >
              ...
              <motion.div
                ...
                className="flex justify-start pt-1 sm:pt-2"
              >
                <Link
                  href="/about-us"
