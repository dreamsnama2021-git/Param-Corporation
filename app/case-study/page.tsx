...
import { Home, ArrowRight, Calendar, Building2, Tag, ChevronRight, Play, Pause, Eye, BookOpen, Clock, User, ArrowUpRight } from 'lucide-react';
      ...
      {activeTab === 'read' && (
        <section className="py-16 lg:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {blogs.map((blog) => (
              ...
              >
                ...
                <Link href={`/blogs/${blog.slug}`} className="block relative aspect-[16/10] overflow-hidden">
                  ...
                  {/* Category Badge */}
                  <span className="absolute top-4 left-4 px-3 py-1 rounded-full bg-white/90 backdrop-blur-sm text-xs font-semibold text-gray-900">
                    {blog.category}
                  </span>
                </Link>
                ...
                <div className="p-6">
                  ...
                  <Link href={`/blogs/${blog.slug}`}>
                    <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-[var(--clr-primary)] transition-colors line-clamp-2">
                      {blog.title}
                    </h3>
                  </Link>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {blog.tags.map((tag) => (
                      <span key={tag} className="px-2 py-1 rounded-md bg-gray-100 text-gray-600 text-[11px] font-medium">
                        {tag}
                      </span>
                    ))}
                  </div>
                  ...
                  <Link 
                    ...
                    className="inline-flex items-center gap-1 text-sm font-semibold text-[var(--clr-primary)] hover:text-[var(--clr-secondary)] transition-colors"
                  >
                    Read Article
          ...
          <div className="text-center mt-12">
            <Link
              href="/blogs"
              className="inline-flex items-center gap-2 px-8 py-4 bg-gray-900 text-white rounded-lg font-semibold hover:bg-gray-800 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5"
            >
              View All Articles
