      ...
      try {
        await fetch("/api/contact", {
          ...
          body: JSON.stringify({
            ...
            categoryName: selectedSubcategory?.categoryName || "All Categories",
            source: `Catalogue Download - ${selectedSubcategory?.categoryName || "General"}`,
          }),
        });
      } catch (err) {
