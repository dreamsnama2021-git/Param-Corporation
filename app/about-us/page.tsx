...
import { EditorialTimeline, TimelineItem } from '../../components/EditorialTImeline';
...
const timelineItems: TimelineItem[] = [
  ...
  },
  {
    ...
    category: "Growth",
    icon: Star,
    image: "https://images.unsplash.com/photo-1553028826-f4804a6d8313?w=800&q=80"
  },
];
    ...
    <div className="bg-white min-h-screen selection:bg-blue-500 selection:text-white">
      ...
      <section className="py-32 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center mb-32">
          <span className="inline-block px-4 py-1 rounded-full bg-blue-50 text-blue-600 text-xs font-bold uppercase tracking-widest mb-6">Experience the Legacy</span>
          <h2 className="text-5xl md:text-6xl font-black text-slate-900 tracking-tighter">
            A Journey Defined <br/> by <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">Innovation</span>
          </h2>
        </div>
